...
# Path to the main gallery images
gallery_dir = r"public/images/gallery"
        ...
        for file in files:
            if file.lower().endswith(image_extensions):
                ...
                if total_images % 50 == 0:
                    print(f"Progress: Processed {total_images} images. Faces detected: {total_faces_detected}, Faces blurred: {total_faces_blurred}")
